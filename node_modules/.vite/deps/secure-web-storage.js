...
var require_generate = __commonJS({
  "node_modules/generate-js/generate.js"(exports, module) {
...
var require_secure_storage = __commonJS({
  "node_modules/secure-web-storage/secure-storage.js"(exports, module) {
    var Generator = require_generate();
    var SecureStorage = Generator.generate(
      function SecureStorage2(storage, options) {
        var _ = this;
        _.storage = storage;
        if (options) {
          _.hash = options.hash;
...
export default require_secure_storage();
//# sourceMappingURL=secure-web-storage.js.map
